    ...
    render(){
        return (
            <div className='ancientMystery'>
                ...
                {this.props.isMystery1Active?<ShubNiggurathMysteryCard1 characters={this.props.characters} mysteryDecrement={this.mysteryDecrement} mysteryCounter={this.props.mysteryCounter} mysteryIncrementHalf={this.mysteryIncrementHalf} key={this.props.ancientCardFlipped} mysteryDeck={this.mysteryDeck} victory={this.props.victory} ancientCardFlipped={this.props.ancientCardFlipped} mysteryDone={this.props.ancientCardFlipped && this.mysteryDeck.length === 0 ? this.mysteryDoneFinal : this.mysteryDone}/>:null}
                ...
                {this.props.isMystery3Active?<ShubNiggurathMysteryCard3 characters={this.props.characters} mysteryDecrement={this.mysteryDecrement} mysteryCounter={this.props.mysteryCounter} mysteryIncrementDouble={this.mysteryIncrementDouble} key={this.props.ancientCardFlipped} mysteryDeck={this.mysteryDeck} victory={this.props.victory} ancientCardFlipped={this.props.ancientCardFlipped} mysteryDone={this.props.ancientCardFlipped && this.mysteryDeck.length === 0 ? this.mysteryDoneFinal : this.mysteryDone}/>:null}
