...
import AzathothBoard from "../Components/AzathothBoard";
import Popup from "reactjs-popup";
import chooseRandom from '../Components/Shuffler';
import './AllPages.css'

class Azathoth extends Component {
    constructor({ loadAzathothLvlChar, level, characters, handleExpeditionShuffle, handleExpeditionDiscard, removeExpedition, victory, defeat }) {
        super();
        ...
        this.state = {
            loadAzathothLvlChar: loadAzathothLvlChar,
            level: level,
        ...
        if (level === 'Easy') {
            this.mythosDeck.push(chooseRandom(this.mythosDeckGreenEasy)); 
            ...
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckYellowEasy));
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckYellowEasy));
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckBlueEasy));  
            ...
            this.mythosDeck.push(chooseRandom(this.mythosDeckGreenNormal));
            ...
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckYellowNormal)); 
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckYellowNormal));
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckBlueNormal)); 
            ...
            this.mythosDeck.push(chooseRandom(this.mythosDeckGreenHard));
            ...
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckYellowHard)); 
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckYellowHard));
            this.mythosDeckStage2.push(chooseRandom(this.mythosDeckBlueHard));  
    ...
    render() {
        return (
            <div className="azathoth">
                <EldritchBoard>
                    <div className="topDiv">
                        <div className="boardDiv">
                            <div className="flexDiv">
                                <button className="backBoardButton" onClick={this.state.loadAzathothLvlChar}></button>
                                {/* <button onClick={this.removeExpedition}>CLICK ME</button> */}
                                <AzathothBoard level={this.state.level} 
