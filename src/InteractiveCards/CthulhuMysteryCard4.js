...
const CthulhuMysteryCard4 = ({ characters, mysteryDecrementMonster, mysteryCounter, mysteryIncrementMonster, monsterSlayed, mysteryDeck, victory, ancientCardFlipped, mysteryDone, }) => {
